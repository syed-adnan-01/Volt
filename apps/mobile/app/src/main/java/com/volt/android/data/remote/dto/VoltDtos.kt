...
data class StationPredictionDto(
    ...
    @SerialName("predictedAvailablePlugs") val predictedAvailablePlugs: Int? = null,
    @SerialName("availabilityProbability") val availabilityProbability: Double? = null,
    @SerialName("expectedWaitMinutes") val expectedWaitMinutes: Double? = null,
    @SerialName("predictedWaitMinutes") val predictedWaitMinutes: Double? = null,
